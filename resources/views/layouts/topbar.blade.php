<div class="topbar d-flex justify-content-between flex-column flex-md-row p-3 py-0 px-md-4 bg-white border-bottom">
    ...
    <div class="my-3">
        <a href="tel:622745305505"><i class="fas fa-phone-alt"></i> <span>0274-5305505</span></a>
        <a href="javascript:void(0);"><i class="fas fa-comments"></i> <span>Live Chat</span></a>
        <a href="{{ url('login') }}"><i class="fas fa-user-circle"></i> <span>Member Area</span></a>
    </div>
</div>
